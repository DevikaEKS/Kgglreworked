...
// import './Analysis.css'; // Add this if you want to include custom styles
...
//             <img src={analyse1} alt="Measuring, Understanding, Predicting" className='img-fluid me-lg-3' />
//             <p className='text-center text-lg-start txtanalyse'>Measuring, Understanding, Predicting</p>
//           </div>
//         </div>
...
//         <div className='col-12 col-lg-6 my-3'>
//           <div className='d-flex flex-column flex-lg-row align-items-center'>
//             <img src={analyse2} alt="Strategy and Governance" className='img-fluid me-lg-3' />
//             <p className='text-center text-lg-start txtanalyse'>Strategy and Governance</p>
//           </div>
//         </div>
