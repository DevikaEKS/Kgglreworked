...
//             <div className='card cred yeartext mb-5 py-3 rounded-4'>
//               <h1>7+</h1>
...
//     <div className='card yeartext1 cred1 d-flex flex-column justify-content-center align-items-center '>
//       <h1>7+</h1>
//       <h2>Countries</h2>
//     </div>
//   </div>
//   <div className='col-sm-12 col-md-4 my-2'>
//     <div className='card profcard  cred1 d-flex flex-column justify-content-center align-items-center '>
//       <h1>500+</h1>
//       <h2>Projects</h2>
//     </div>
//   </div>
...
//   </div>
//   <div className='col-sm-12 col-md-4 my-2'>
//     <div className='card yeartext1 m-2 p-4 cred1 d-flex flex-column justify-content-center align-items-center '>
//       <h1>270+</h1>
//       <h2>Clients</h2>
//       </div>
//       </div>
