    ...
    <div className='container my-5'>
      <div className='row align-items-center missionparts'>
        ...
        <div className='col-12 col-lg-6 d-flex flex-column flex-md-row align-items-center mb-4 mb-md-0'>
          ...
          <img src={visionim} className='section-image ms-0 ms-md-4 mt-3 mt-md-0 rounded-4' title='Our Mission' alt="To empower businesses with cutting-edge infrastructure solutions, SAP expertise, and impactful digital marketing strategies, driving innovation, efficiency, and growth" />
        </div>

        {/* Vision Section */}
        <div className='col-12 col-lg-6 d-flex flex-column flex-md-row align-items-center'>
   
          <img src={missionim} className='section-image me-0 me-md-4 mb-5 pb-5 mb-md-0' title='Our Vision' alt="At KG Genius Labs, our vision is to be a leading provider of diverse services, SAP solutions, and digital marketing, empowering businesses to achieve their full potential through innovative technology and strategic digital growth." />
          <h1 className='serviceheading1 d-block d-md-none'>
                <Typewriter
                  options={{
                   strings: ['VISION'],
                    autoStart: true,
          ...
          <div className='vision-content text-center text-md-start'>
            ...
            <div className='fixed-width-text'>
              <h1 className='serviceheading1 pt-5 d-none d-md-block'>
                <Typewriter
                  options={{
                   strings: ['VISION'],
                    autoStart: true,
