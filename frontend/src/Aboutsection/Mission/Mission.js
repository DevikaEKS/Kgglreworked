    ...
    <div className='container my-5'>
      <div className='row align-items-center missionparts'>
        ...
        <div className='col-12 col-lg-6 d-flex flex-column flex-md-row align-items-center mb-4 mb-md-0'>
          ...
          <img src={visionim} className='section-image ms-0 ms-md-4 mt-3 mt-md-0 rounded-4 d-none d-md-block' title='Our Mission' alt="To empower businesses with cutting-edge infrastructure solutions, SAP expertise, and impactful digital marketing strategies, driving innovation, efficiency, and growth" />
        </div>
        ...
        <img src={mvim} className='mvimg d-block d-md-none' alt='mission and vision'/>
